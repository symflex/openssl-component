...
use Symflex\Component\OpenSSL\Signature\Algorithm\Rsa\Sha512;
use Symflex\Component\OpenSSL\Signature\OpenSSL;
use Symflex\Component\OpenSSL\Tests\Unit\KeySetUp;

/**
 * @coversDefaultClass \Symflex\Component\OpenSSL\Signature\Algorithm\Rsa\Sha512
 */
class Sha512Test extends TestCase
{
    ...
    public function signTest()
    {
        ...
        $signer = new Sha512($publicKey, $privateKey);
